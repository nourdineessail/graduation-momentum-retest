...
async function main() {
  ...
  const tx = await conn.getTransaction('4YBegD7pQTdAgmE86J8jxFzsX99AzFaLpE7EjPqEyV6Qsi5yuz8wnfWmUtx3ZPR3dawuaRSTYqZa5hPfWX7hwmPi', { maxSupportedTransactionVersion: 0, commitment: 'confirmed' });
