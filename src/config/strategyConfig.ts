...
export const strategyConfig = {
  // Filters
  MIN_LIQUIDITY_USD: env.MIN_LIQUIDITY_USD || 10000,
  ...
  MAX_SLIPPAGE_PERCENT: env.MAX_SLIPPAGE_PERCENT || 5,
  MAX_POSITION_PERCENT_OF_LIQUIDITY: 1,

  // Risk and Position Sizing (can be overridden by env for testing)
  POSITION_SIZE_USD: env.POSITION_SIZE_USD || 50,
  RISK_PER_TRADE_PERCENT: 0.5,
  MAX_DAILY_LOSS_USD: env.MAX_DAILY_LOSS_USD,
  MAX_CONSECUTIVE_LOSSES: env.MAX_CONSECUTIVE_LOSSES,
  COOLDOWN_AFTER_LOSSES_MINUTES: env.COOLDOWN_AFTER_LOSSES_MINUTES,
  PER_TOKEN_COOLDOWN_MINUTES: env.PER_TOKEN_COOLDOWN_MINUTES,
  STALE_DATA_MAX_SECONDS: env.STALE_DATA_MAX_SECONDS,
  MAX_OPEN_POSITIONS: env.MAX_OPEN_POSITIONS || 3,
  MAX_TRADES_PER_HOUR: env.MAX_TRADES_PER_HOUR || 10,
