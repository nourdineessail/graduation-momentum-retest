...
exports.strategyConfig = {
    // Filters
    MIN_LIQUIDITY_USD: env_1.env.MIN_LIQUIDITY_USD || 10000,
    ...
    MAX_SLIPPAGE_PERCENT: env_1.env.MAX_SLIPPAGE_PERCENT || 5,
    MAX_POSITION_PERCENT_OF_LIQUIDITY: 1,
    // Risk and Position Sizing (can be overridden by env for testing)
    POSITION_SIZE_USD: env_1.env.POSITION_SIZE_USD || 50,
    RISK_PER_TRADE_PERCENT: 0.5,
    MAX_DAILY_LOSS_USD: env_1.env.MAX_DAILY_LOSS_USD,
    MAX_CONSECUTIVE_LOSSES: env_1.env.MAX_CONSECUTIVE_LOSSES,
    COOLDOWN_AFTER_LOSSES_MINUTES: env_1.env.COOLDOWN_AFTER_LOSSES_MINUTES,
    PER_TOKEN_COOLDOWN_MINUTES: env_1.env.PER_TOKEN_COOLDOWN_MINUTES,
    STALE_DATA_MAX_SECONDS: env_1.env.STALE_DATA_MAX_SECONDS,
    MAX_OPEN_POSITIONS: env_1.env.MAX_OPEN_POSITIONS || 3,
    MAX_TRADES_PER_HOUR: env_1.env.MAX_TRADES_PER_HOUR || 10,
    // Exit strategy
