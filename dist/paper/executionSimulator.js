...
class ExecutionSimulator {
     ...
     */
    static simulateMarketOrder(side, intendedPrice, amountUsd, poolLiquidityUsd) {
        // 1. Check max position relative to liquidity
        const maxAllowedUsd = poolLiquidityUsd * (strategyConfig_1.strategyConfig.MAX_POSITION_PERCENT_OF_LIQUIDITY / 100);
        ...
        if (slippagePercent > strategyConfig_1.strategyConfig.MAX_SLIPPAGE_PERCENT) {
            if (side === 'BUY') {
                ...
                slippagePercent = strategyConfig_1.strategyConfig.MAX_SLIPPAGE_PERCENT * 1.5; // Penalty for forced exit
            }
        }
        ...
        // 4. Calculate fees
        const feesUsd = amountUsd * (constants_1.DEX_FEE_PERCENT / 100);
